...
<?php 
   ...
   if(!($loginedUser instanceof Manager)){
    ...
    $report = $loginedUser->getMonthlyReport($_GET["id"]);
...
<head>
  <meta charset="UTF-8">
  <title>Monthly Report | Core Bank</title>
...
<div class="wrapper" id="invoice">
   <div class="container">
      <p class="thanks"> Your Monthly Report is Ready!</p>

      <button class="cta"> Print Report</button>
      <div class="receipt" >
         <div class="receipt__message">
            <h2 class="receipt__title">Monthly Report!</h2>
            ...
            <a class="btn dontprint" href="monthly Report.php">View All Monthly Report</a>
         </div>
         ...
         <div class="product">
            ...
            <div>
               ...
               <p class="product__quantity">From <?php echo $report->getStartDate()?> To <?php echo $report->getendDate()?></p>
