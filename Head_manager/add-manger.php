                                            ...
                                            <div class="review-content-section">
                                                ...
                                                <?php
                                                    if(isset($_POST['addManagerBtn'])){
                                                       ...
                                                       $ID = $loginedUser->addStaff($fullname,$address,$phoneNo,$DOB,$nic,$branchCode,$email,$password,$fileDestination,'manager');
                            ...
                            <?php
                                if(!empty($_FILES)){
                                    ...
                                    if (in_array($fileExt,$allowedExt)){
                                        if($fileError ===0){
                                            if($fileSize<=2000000){
                                                $fileUniqueName = "../img/profile/".uniqid('',true).".".$fileExt;
