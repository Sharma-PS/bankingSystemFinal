            ...
            use Classess\Auth\Manager;
                ...
                if(isset($_POST['giveApprove'])){                                
                    $msg = $detail->givePermisionToLoan($loginedUser->getID()) ;            
                }
                if(isset($_POST['rejectLoan'])){                                
                    $msg = $detail->rejectLoan();            
                }
            ?>
<script>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Pending Loan Details</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-centered">
                        <div class="profile-info-inner">
                            <div class="profile-img">
                                <img style="border: 0.5px solid black;border-radius: 10px;" src="../img/loan/pendingLoan.png" alt="Image" />
                            </div>
                            <div class="profile-details-hr">
                                ...
                                <div class="row">
                                    ...
                                    <form class="address-hr " method="POST" action="#">
                                        <input type="submit" value="Give Approve" name="giveApprove"  class="btn btn-primary waves-effect waves-light">
                                        <input type="submit" value="Reject Loan" name="rejectLoan"  class="btn btn-custon-rounded-four btn-danger">
                                    </form>
                                    <?php echo @$msg; ?>
                                </div>                                
                            </div>
