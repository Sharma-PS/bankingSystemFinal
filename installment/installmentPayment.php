...
if (isset($_POST["Pay"])) {
    $msg = $loginedUser->makePayment($_POST["loanID"], $_POST["payment"]);
}
?>
<script>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            ...
                            <div class="add-product">
                                <a href="viewInstallments.php">View Installments</a>
                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="#" class="dropzone dropzone-custom needsclick addpayment" id="demo1-upload" method="POST">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
