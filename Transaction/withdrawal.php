...
if (isset($_POST["Withdraw"])) {
    ...
    $msg = $loginedUser->withdrawMoney($_POST["accID"], $_POST["amountOfMoney"], $des);
}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <ul class="breadcome-menu">
                                    ...
                                    <li><span class="bread-blod">Withdraw</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="sparkline10-list mt-b-30">
                    <div class="sparkline10-hd">
                        <div class="main-sparkline10-hd">
                            <h1>Withdraw Money <span class="basic-ds-n">from Account</span></h1>
                        </div>
                    </div>
                                                        ...
                                                        <div class="login-btn-inner">
                                                            <div class="row">                                                                
                                                                <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12 form-group">
                                                                    <div class="login-horizental lg-hz-mg"><button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="Withdraw">Withdraw</button></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>                                                    
